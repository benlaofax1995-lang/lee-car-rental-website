...
export const VEHICLES: Vehicle[] = [
  // ── Vans ──────────────────────────────────────────────────────
  {
    ...
    name: '2023 Ford Transit Cargo Van',
    year: 2023,
    make: 'Ford',
    model: 'Transit',
    trim: 'Cargo Van',
    category: 'Van',
    description: 'Spacious Ford Transit cargo van — perfect for moves, deliveries, contractor work, and hauling. Plenty of room and well-maintained.',
    seats: 3,
    dailyRate: 151,
    features: ['Backup Camera', 'Bluetooth', 'USB Charging', 'A/C', 'Cargo Space', 'Automatic'],
  ...
  },
  {
    ...
    trim: 'Passenger Wagon',
    category: 'Van',
    description: 'Large Ford Transit-150 passenger wagon — great for group travel, airport shuttles, and family trips with comfortable seating for everyone.',
    seats: 12,
    dailyRate: 151,
